...
IMAGE_PATH = BENCHMARK_DIR / "CEO-F01.jpeg"
IMAGE_ID = "CEO-F01"
...
def encode_image_to_base64(image_path) -> str:
    ...
    if not path.exists():
        alt_path = path.parent / "WhatsApp Image 2026-08-04 at 4.47.08 PM.jpeg"
        if alt_path.exists():
            path = alt_path
        else:
...
def run_benchmark():
    ...
    headers = {
        ...
        "X-Title": "Shahdol Anganwadi Child Count Benchmark",
    }
    ...
    try:
        ...
        # Parse child count if available
        ...
        try:
            ...
            child_count_display = f"Could not parse JSON from raw response: {raw_response}"
